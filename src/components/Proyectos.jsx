        ...
        <section id="projects" className="py-20 bg-black">
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-wrap justify-center mb-16 gap-3">
                    ...
                    <button onClick={() => filterProjects("mcllent")}
                        className={`px-8 py-2.5 rounded-full text-sm font-bold transition-all duration-300 ${selectedCategory === "mcllent" ? "bg-yellow-500 text-black shadow-[0_0_20px_rgba(234,179,8,0.3)]" : "bg-zinc-900 text-zinc-400 border border-zinc-800 hover:border-yellow-500/50"}`}>
                        MCLLENT
                    </button>
                </div>
